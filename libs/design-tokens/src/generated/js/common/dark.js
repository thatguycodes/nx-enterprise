...
module.exports = {
  ...
  color: {
    primary: {
      default: {
        key: "{color.primary.default}",
        $type: "color",
        $value: "#7c3aed",
        filePath:
          "/Users/letlhogonolotheodoreobonye/Code/monorepos/nx-enterprise/libs/design-tokens/src/tokens/themes/dark.json",
        isSource: true,
        original: {
          $type: "color",
          $value: "{brand.60}",
    ...
    background: {
      ...
      faint: {
        ...
        name: "colorBackgroundFaint",
        attributes: {
          category: "color",
          type: "background",
          item: "faint",
        },
        path: ["color", "background", "faint"],
      },
    },
    border: {
      default: {
